 ...
 * <artifactId>reflections</artifactId> <version>0.9.12</version> </dependency>
 *
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		for (Iterator<Class<? extends Object>> it = allClasses.iterator(); it.hasNext();) {
			...
			for (Method method : methods) {
				System.out.println("===================================================================");
				System.out.println("Get methods Name[" + ++methodIdx + "]" + method.getReturnType().getSimpleName()
						+ " " + method.getName());
				...
				if (oparamClazz == null) {
					...
					System.out.println(String.format(" %s<%s>:", method.getReturnType().getSimpleName(),
							oparamClazz.getSimpleName()));
				}
	...
	private static void extractedInParams(String packageSimpleName, Method method) {
		...
		for (Parameter parameter : parameters) {
			...
			if (paramClazz == null) {
				...
				System.out.println(
						String.format(" %s<%s>:", parameter.getType().getSimpleName(), paramClazz.getSimpleName()));
			}
